...
void moveBase(float dt)
{
    ...
    Kinematics::MotorRPM req_rpm = kinematics.calculateRPM(cmd_vel_msg.linear.x, cmd_vel_msg.angular.z);
    ...
    speed_msg.data.data[0] = target_rpm1;
    speed_msg.data.data[1] = target_rpm2;
    speed_msg.data.data[2] = target_rpm3;
    speed_msg.data.data[3] = target_rpm4;
